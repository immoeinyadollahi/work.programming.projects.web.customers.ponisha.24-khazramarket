                                                            ...
                                                            @foreach($cart->products as $product)
                                                                ...
                                                                <div class="row list-row">
                                                                    ...
                                                                    <div class="col-8 col-sm-9 col-md-3">
                                                                        <strong class="cart-product-price"><span class="currency-suffix">{{ trans('front::messages.currency.prefix') }}</span>{{ number_format($price_to_stock->discountPrice() * $product->pivot->quantity) }} <span class="currency-suffix">{{ trans('front::messages.currency.suffix') }}</span></strong>

                                                                        @if($price_to_stock->discount)
                                                                            <del class="text-danger old-cart-product-price"><span class="currency-suffix">{{ trans('front::messages.currency.prefix') }}</span>{{ number_format($price_to_stock->tomanPrice() * $product->pivot->quantity) }} <span class="currency-suffix">{{ trans('front::messages.currency.suffix') }}</span></del>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                            @endforeach
