                ...
                <div class="dt-sl dt-sn">
                    <div class="row table-draught px-3">
                        ...
                        <div class="col-md-2 col-sm-12">
                            <span class="title">اعلام مرجوعی</span>
                            @if ($order->shipping_status == "sent" && $order->created_at->addDays(15) >= Carbon\Carbon::now() )
                   
                             <a href="{{ route('front.returned.create', ['id' => $order->id]) }}" class=" col-md-12 btn btn-danger mb-2">اعلام مرجوعی</a>
                            @endif
                        </div>
