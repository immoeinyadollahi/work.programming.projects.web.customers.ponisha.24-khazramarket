                    ...
                    <div id="main-card" class="card-content">
                        <div class="card-body">
                            <div class="col-12 col-md-10 offset-md-1">
                                <form class="form" id="slider-edit-form"
                                    action="{{ route('admin.sliders.update', ['slider' => $slider]) }}" method="slider">
                                    @csrf
                                    @method('put')
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control slider-link ltr"
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control slider-category" name="category_id">
                                                    ...
                                                    <select class="form-control" name="group">
                                                        @if (config('front.sliderGroups'))
                                                            @foreach (config('front.sliderGroups') as $sliderGroup)
                                                                <option value="{{ $sliderGroup['group'] }}"
                                                                    {{ $slider->group == $sliderGroup['group'] ? 'selected' : '' }}>
                                                                    {{ $sliderGroup['name'] }}
                                                                    {{ $sliderGroup['size'] }}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
...
@push('scripts')
    ...
    <script src="{{ asset('back/assets/js/pages/sliders/all.js') }}"></script>
