...
use Themes\DefaultTheme\src\Controllers\ReturnedController;
...
Route::group(['as' => 'front.'], function () {
    ...
    // ------------------ returned
    Route::get('returned/{id}/create', [ReturnedController::class, 'create'])->name('returned.create');
    Route::post('returned/{order}/store', [ReturnedController::class, 'store'])->name('returned.store');
    Route::post('returned/traking/{return}', [ReturnedController::class, 'traking'])->name('returned.traking');

    Route::get('returned/index', [ReturnedController::class, 'index'])->name('returned/index');
    Route::get('returned/{returned}', [ReturnedController::class, 'index_product'])->name('returned.index.product');

    Route::get('auth/check', [MainController::class, 'authCheck'])->name("auth-check");
