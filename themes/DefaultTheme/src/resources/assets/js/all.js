    ...
    var adapt = function adapt(wrapper) {
      ...
      if (isOverflow) {
        ...
        if (marginLeft + item.width() + shadowRight > $(tab).width()) {
          ...
          if (index) {
            var delta = $(tab).width() - marginLeft - shadowRight; //if distance to the right is less than the width of the tab list
...
function block(el) {
  var block_ele = $(el); // Block Element
