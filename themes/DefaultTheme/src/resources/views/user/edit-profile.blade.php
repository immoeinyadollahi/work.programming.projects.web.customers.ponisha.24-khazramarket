                ...
                <form id="profile-form" action="{{ route('front.user.profile.update') }}" class="setting_form" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-4">
                            ...
                            <div class="form-row form-group">
                                <input type="text" class="input-ui pr-2" name="card_number" value="{{ $user->card_number ? $user->card_number : '' }}">
                            </div>
                            <div class="form-row-title">
                                <h3>شماره شبا</h3>
                            </div>
                            <div class="form-row form-group">
                                <input type="text" class="input-ui pr-2" name="IBN_number" value="{{ $user->IBN_number ? $user->IBN_number : '' }}">
                            </div>
                        </div>
                        <div class="col-lg-6 mt-4">
                            <div class="form-row-title">
