...
Route::group(['as' => 'admin.', 'prefix' => 'admin/' . admin_route_prefix(), 'middleware' => ['auth', 'Admin', 'verified', 'CheckPasswordChange', 'password.confirm']], function () {
    ...
    // ------------------ returned
    Route::get('returned/show', [ReturnedController::class, 'show'])->name('returned.show');
    Route::get('returned/prduct-index/{returned}', [ReturnedController::class, 'index'])->name('return.product.index');
    Route::post('returnde/api/index', [ReturnedController::class, 'apiIndex'])->name('returned.apiIndex');
    Route::post('returned/update/{return}', [ReturnedItemController::class, 'update'])->name('return.update');
